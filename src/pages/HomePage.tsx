...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="w-full bg-[#FAF8F5]">
      ...
      <section
        id="hero-section"
        className="relative min-h-[100svh] min-h-[100vh] flex flex-col justify-between pt-20 sm:pt-24 lg:pt-26 pb-8 sm:pb-12 lg:pb-14 px-4 sm:px-8 lg:px-12 bg-[#141311] overflow-hidden"
      >
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#141311]/95 via-[#141311]/40 to-black/20" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#141311]/80 via-transparent to-transparent" />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full space-y-8 sm:space-y-10 my-auto py-4">
          
          <div className="max-w-3xl text-[#FAF8F5] space-y-4 sm:space-y-6 animate-hero-text">
            
            <div className="inline-flex items-center space-x-3 text-[10px] sm:text-[11px] uppercase tracking-[0.28em] text-[#DFCABA] font-mono">
              <span className="w-2 h-[1px] bg-[#DFCABA]" />
              <span>Simple Grain Atelier • Dhaka</span>
            </div>

            <h1 className="font-serif text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-normal leading-[1.08] tracking-tight text-[#FAF8F5]">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 pt-2 sm:pt-4">
              <button
                ...
                className="px-7 sm:px-8 py-3.5 sm:py-4 bg-[#FAF8F5] text-[#141311] text-xs font-semibold uppercase tracking-[0.2em] rounded-xs hover:bg-[#E5DECF] transition-all flex items-center justify-center space-x-2 shadow-sm cursor-pointer group"
              >
              ...
              <button
                ...
                className="px-7 sm:px-8 py-3.5 sm:py-4 bg-transparent text-[#FAF8F5] border border-[#FAF8F5]/40 text-xs font-medium uppercase tracking-[0.2em] rounded-xs hover:bg-[#FAF8F5]/10 transition-all flex items-center justify-center backdrop-luxury cursor-pointer"
              >
          ...
          <div className="pt-6 sm:pt-8 flex flex-col sm:flex-row sm:items-center justify-between text-[10px] sm:text-[11px] text-[#A29B8F] tracking-[0.2em] uppercase border-t border-[#FAF8F5]/15 font-mono gap-2">
      ...
      ========================================================================= */}
      <section id="brand-intro-section" className="py-28 sm:py-40 px-4 sm:px-8 lg:px-12 bg-[#FAF8F5]">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          
          <span className="text-[10px] uppercase tracking-[0.3em] text-[#8E7048] font-mono block">
            THE SIMPLE GRAIN PHILOSOPHY
          </span>

          <h2 className="font-serif text-3xl sm:text-5xl lg:text-6xl text-[#141311] font-normal leading-[1.18] tracking-tight">
            “Your home deserves more than furniture. <br className="hidden sm:inline" />
            It deserves pieces that belong.”
          </h2>

          <p className="text-sm sm:text-base text-[#5C564E] leading-relaxed max-w-2xl mx-auto font-light">
          ...
          <div className="pt-2">
            <button
              ...
              className="text-xs uppercase tracking-[0.22em] font-semibold text-[#141311] luxury-link pb-1 hover:text-[#8E7048] transition-colors cursor-pointer"
            >
      ...
      ========================================================================= */}
      <section id="featured-collections-section" className="py-24 px-4 sm:px-8 lg:px-12 bg-[#F6F3ED] border-t border-[#E5DECF]">
        <div className="max-w-7xl mx-auto space-y-12">
          
          <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-[#E5DECF] pb-6">
            <div>
              <span className="text-[10px] uppercase tracking-[0.28em] text-[#8E7048] font-mono">
                CURATED ARCHETYPES
              </span>
              <h2 className="font-serif text-3xl sm:text-4xl text-[#141311] font-normal mt-1">
                Explore by Living Space
              </h2>
            </div>
            <button
              onClick={() => setCurrentPage('collection')}
              className="text-xs uppercase tracking-[0.2em] font-semibold text-[#141311] hover:text-[#8E7048] transition-colors mt-4 md:mt-0 flex items-center space-x-1 cursor-pointer"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            >
              ...
              <div className="absolute bottom-8 left-8 right-8 text-[#FAF8F5] flex items-end justify-between">
                <div className="space-y-1.5 max-w-md">
                  <span className="text-[9px] uppercase tracking-[0.25em] text-[#DFCABA] font-mono">
                    {CATEGORIES[0].count} Handcrafted Designs
                  </span>
                  <h3 className="font-serif text-2xl sm:text-3xl font-medium">{CATEGORIES[0].name}</h3>
                  <p className="text-xs text-[#E5DECF] line-clamp-2 font-light">{CATEGORIES[0].description}</p>
                </div>
                <span className="p-3 bg-[#FAF8F5]/15 backdrop-luxury text-[#FAF8F5] group-hover:bg-[#FAF8F5] group-hover:text-[#141311] transition-all shrink-0">
                  <ArrowRight size={16} />
                </span>
              </div>
            </div>
            ...
            <div
              ...
              className="md:col-span-4 group relative aspect-[4/5] md:aspect-auto bg-[#E5DECF] overflow-hidden cursor-pointer shadow-xs"
            >
              <img
              ...
              <div className="absolute bottom-8 left-8 right-8 text-[#FAF8F5] flex items-end justify-between">
                <div className="space-y-1">
                  ...
                  <h3 className="font-serif text-2xl font-medium">{CATEGORIES[1].name}</h3>
                  <p className="text-xs text-[#E5DECF] line-clamp-2 font-light">{CATEGORIES[1].description}</p>
                </div>
                <span className="p-2.5 bg-[#FAF8F5]/15 backdrop-luxury text-[#FAF8F5] group-hover:bg-[#FAF8F5] group-hover:text-[#141311] transition-all shrink-0">
                  <ArrowRight size={15} />
                </span>
              </div>
            </div>
            ...
            {CATEGORIES.slice(2).map((cat) => (
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6 text-[#FAF8F5] flex items-end justify-between">
                  <div className="space-y-0.5">
                    <span className="text-[9px] uppercase tracking-[0.25em] text-[#DFCABA] font-mono">
                      {cat.count} Designs
                    </span>
                    <h3 className="font-serif text-xl font-medium">{cat.name}</h3>
                  </div>
      ...
      ========================================================================= */}
      <section id="featured-pieces-section" className="py-28 sm:py-36 px-4 sm:px-8 lg:px-12 bg-[#FAF8F5]">
        <div className="max-w-7xl mx-auto space-y-16">
          
          <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-[#E5DECF] pb-6 gap-4">
            <div>
              <span className="text-[10px] uppercase tracking-[0.28em] text-[#8E7048] font-mono">
                THE SIGNATURE CATALOG
              </span>
              <h2 className="font-serif text-3xl sm:text-5xl text-[#141311] font-normal mt-1">
          ...
          <div className="pt-6 text-center">
            <button
              onClick={() => setCurrentPage('collection')}
              className="px-10 py-4 bg-[#141311] text-[#FAF8F5] text-xs font-semibold uppercase tracking-[0.22em] rounded-xs hover:bg-[#3D3934] transition-all inline-flex items-center space-x-2 shadow-xs cursor-pointer"
            >
      ...
      ========================================================================= */}
      <section id="craftsmanship-highlight-section" className="py-28 px-4 sm:px-8 lg:px-12 bg-[#1C1A18] text-[#FAF8F5]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 relative aspect-[4/3] overflow-hidden bg-[#141311] shadow-2xl">
            ...
            <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between text-xs text-[#E5DECF] font-mono">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <h2 className="font-serif text-3xl sm:text-5xl font-normal leading-[1.12] text-[#FAF8F5]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 border-t border-[#292623]">
              <div className="space-y-1">
                <h4 className="font-serif text-lg text-[#FAF8F5]">Zero Synthetic Lacquers</h4>
              ...
              <div className="space-y-1">
                <h4 className="font-serif text-lg text-[#FAF8F5]">10-Year Timber Guarantee</h4>
                <p className="text-xs text-[#A29B8F] leading-relaxed font-light">
            ...
            <div className="pt-4">
              <button
                onClick={() => setCurrentPage('craftsmanship')}
                className="px-8 py-3.5 bg-[#FAF8F5] text-[#141311] text-xs font-semibold uppercase tracking-[0.2em] rounded-xs hover:bg-[#E5DECF] transition-colors inline-flex items-center space-x-2 cursor-pointer"
              >
      ...
      ========================================================================= */}
      <section id="lookbook-teaser-section" className="py-24 px-4 sm:px-8 lg:px-12 bg-[#F6F3ED]">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-[#E5DECF] pb-6">
            ...
            <button
              ...
              className="text-xs uppercase tracking-[0.2em] font-semibold text-[#141311] hover:text-[#8E7048] transition-colors mt-2 md:mt-0 flex items-center space-x-1 cursor-pointer"
            >
          ...
          <div
            onClick={() => setCurrentPage('lookbook')}
            className="relative aspect-[21/9] min-h-[380px] overflow-hidden cursor-pointer group shadow-lg"
          >
            <img
            ...
            <div className="absolute bottom-8 left-8 right-8 text-[#FAF8F5] flex flex-col md:flex-row md:items-end justify-between gap-4">
              <div className="space-y-2 max-w-xl">
                <span className="text-[10px] uppercase tracking-[0.25em] text-[#DFCABA] font-mono">
                  {heroLookbook.subtitle} • {heroLookbook.locationContext}
                </span>
                <h3 className="font-serif text-3xl sm:text-4xl font-medium">{heroLookbook.title}</h3>
                <p className="text-xs text-[#E5DECF] font-light leading-relaxed">
                  {heroLookbook.description}
                </p>
              </div>

              <span className="px-6 py-3.5 bg-[#FAF8F5] text-[#141311] text-xs uppercase tracking-[0.18em] font-semibold rounded-xs group-hover:bg-[#E5DECF] transition-colors self-start md:self-auto shrink-0 flex items-center space-x-2">
      ...
      ========================================================================= */}
      <section id="room-visualizer-teaser-section" className="py-28 px-4 sm:px-8 lg:px-12 bg-[#141311] text-[#FAF8F5]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <ul className="space-y-3 text-xs text-[#A29B8F] font-light">
              <li className="flex items-center space-x-2.5">
                <Check size={14} className="text-[#8E7048]" />
            ...
            <div className="pt-2">
              <button
                ...
                className="px-8 py-4 bg-[#FAF8F5] text-[#141311] text-xs font-semibold uppercase tracking-[0.2em] rounded-xs hover:bg-[#E5DECF] transition-all inline-flex items-center space-x-2 shadow-sm cursor-pointer"
              >
          ...
          <div
            onClick={() => setCurrentPage('visualizer')}
            className="lg:col-span-6 relative aspect-[4/3] bg-[#1C1A18] overflow-hidden border border-[#292623] p-4 group cursor-pointer"
          >
            <img
            ...
            <div className="absolute top-8 left-8 right-8 flex items-center justify-between pointer-events-none">
              <div className="bg-[#141311]/90 backdrop-luxury text-[#FAF8F5] px-3 py-1.5 rounded-xs text-[11px] font-mono border border-[#292623]">
                Sunlit Living Pavilion • Midday Light
              </div>
              <div className="bg-[#FAF8F5] text-[#141311] px-3 py-1.5 rounded-xs text-[10px] font-medium uppercase tracking-wider">
                Interactive
              </div>
            </div>
          </div>
      ...
      ========================================================================= */}
      <section id="journal-preview-section" className="py-28 px-4 sm:px-8 lg:px-12 bg-[#FAF8F5]">
        <div className="max-w-7xl mx-auto space-y-12">
            ...
            {JOURNAL_ARTICLES.slice(0, 3).map((article) => (
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <h3 className="font-serif text-xl text-[#141311] group-hover:text-[#8E7048] transition-colors leading-snug font-medium">
                    {article.title}
                  </h3>
      ...
      ========================================================================= */}
      <section id="trust-service-section" className="py-24 px-4 sm:px-8 lg:px-12 bg-[#F6F3ED] border-t border-[#E5DECF]">
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-3">
              ...
              <h4 className="font-serif text-lg text-[#141311] font-medium">Nationwide White-Glove</h4>
            ...
            <div className="space-y-3">
              ...
              <h4 className="font-serif text-lg text-[#141311] font-medium">10-Year Timber Warranty</h4>
              <p className="text-xs text-[#5C564E] leading-relaxed font-light">
            ...
            <div className="space-y-3">
              ...
              <h4 className="font-serif text-lg text-[#141311] font-medium">Master Installation</h4>
              <p className="text-xs text-[#5C564E] leading-relaxed font-light">
            ...
            <div className="space-y-3">
              ...
              <h4 className="font-serif text-lg text-[#141311] font-medium">Spatial Studio Advice</h4>
              <p className="text-xs text-[#5C564E] leading-relaxed font-light">
      ...
      ========================================================================= */}
      <section id="final-cta-section" className="relative py-32 sm:py-44 px-4 sm:px-8 lg:px-12 bg-[#141311] text-[#FAF8F5] overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center space-y-6">
          ...
          <p className="text-sm sm:text-base text-[#E5DECF] font-light max-w-xl mx-auto leading-relaxed">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-4">
            <button
              onClick={() => setCurrentPage('collection')}
              className="px-9 py-4 bg-[#FAF8F5] text-[#141311] text-xs font-semibold uppercase tracking-[0.2em] rounded-xs hover:bg-[#E5DECF] transition-all shadow-md cursor-pointer flex items-center space-x-2"
            >
            ...
            <button
              ...
              className="px-9 py-4 bg-transparent text-[#FAF8F5] border border-[#FAF8F5]/50 text-xs font-medium uppercase tracking-[0.2em] rounded-xs hover:bg-[#FAF8F5]/10 transition-all backdrop-luxury cursor-pointer"
            >
